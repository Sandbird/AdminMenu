...
"([
	...
	STR_R3F_LOG_action_contenu_vehicule,STR_R3F_ARTY_action_ouvrir_dlg_SM,SP_rearm_actions,SP_repair_action,SP_refuel_action,s_player_deploybike2,s_building_snapping,s_player_sirens_on,s_player_sirens_off,dayz_addsirens
